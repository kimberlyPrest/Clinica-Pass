  ...
  return (
    <PageWrapper>
      <PageHeader
        ...
        subtitle={
          isClinica
            ? 'Gerencie usuários, permissões e prontuários'
            : 'Configure seus campos de prontuário'
        }
      />

      <Tabs defaultValue={isClinica ? 'usuarios' : 'pacientes'}>
        {/* Custom tab bar */}
        ...
        <TabsContent value="pacientes" className="mt-0">
          <DSCard padded={false}>
            <DSCardHeader
              title="Campos Customizados do Prontuário"
              subtitle="Configure os campos clínicos adicionais para os prontuários dos pacientes"
            />
            <div className="p-6">
